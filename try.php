...
<div class="row d-flex justify-content-center ">
    <div class="col-md-6 mt-3">
        <span class="text-white"><?php include_once 'includes/msg.php' ?></span>
    </div>
</div>
    <div class="row">
...
if ($i == 1) {?>
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block mb-5">
        ...
        <span><a href="ts_info.php?ts_id=<?php echo $row['tsinfo_id']?>" class="btn btn-lg btn-flat btn-light text-dark" name="">View Tourist Info</a>
</span>
    </div>
    </div>
<?php
            ...
            <div class="row">
                <div class="col-md">
                    <div class="card text-center">
                        <div class="card-body bg-light">
                            <a href="tourist_spot.php" style="text-decoration:none;"><span class="text-dark">Tourist Spot <i class="fa fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
