...
try {
    ...
    $mail->Body    = 'To Reset your Account Please Click here <a href="http://localhost/capstone/ADMIN/change_pass.php?code='.$code.'">Click Here</a>';
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';



    $send_email = "SELECT * from tbl_admin where email='$email' and user_id = '$user_id'";
    ...
    if (mysqli_num_rows($result) <= 0) {
       ...
       header("location: ../../fp_uniqueID.php");
        ...
        $update_code = mysqli_query($conn, "UPDATE tbl_admin SET user_id = '$code' WHERE email = '$email' ");
        $mail->send();
