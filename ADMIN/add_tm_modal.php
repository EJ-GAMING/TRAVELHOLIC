...
<div class="modal fade" id="addnew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form method="post" action="http://localhost/capstone/ADMIN/includes/U_A_QUERY/insert.php" enctype="multipart/form-data">
...
<select class="form-control" name="tsn" required>
  ...
  <?php $sql ="SELECT * from tbl_ts_info ORDER BY tsinfo_id DESC ";
  ...
  <div class="card-header h3">User Account</div>
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-12">
          <input type="password" name="pass" placeholder="Password" id="pass6" class="form-control" required>
        </div>
        <div class="form-group">
      <div class="row">
        <div class="col d-flex justify-content-md-end">
        <label><input type="checkbox" class="mr-1" onclick="showPassword6();"><strong>Show Password</strong></label>
        </div>
      </div>
    </div>
      </div>
...
<script type="text/javascript">
			function showPassword6(){
				var show = document.getElementById('pass6');
