<nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img class="rounded-circle" src="<?php echo (!empty($user['photo'])) ? '../includes/PROFILE/upload/'.$user['photo'] : '../../photo/profile.jpg';?>"height="40px" class="img-rounded"/></a>
