		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 form-container bg-success">
				<div class="col-lg-8 col-md-12 col-sm-9 col-xs-12 form-box text-center">
					...
					<form method="POST" action="includes/LOGIN_QUERY/session_email.php">
						...
						<div class="row">
							<div class="col-md d-flex align-self-start ">
								<a href="index.php"><i class="fa fa-arrow-left fa-lg mb-2 text-dark"></i></a>
							</div>
						</div>
						<div class="col-md d-flex align-self-start	">
						...
						<button type="submit" class="btn" name="next"><i class="fa fa-arrow-right"></i> <strong>Next</strong></button>
						</div>
