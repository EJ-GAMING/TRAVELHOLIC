...
<div class="row">
                <div class="col-md-3">
                  <Label><b>REGION</b></label>
                    <select id="region1" name="region" class="form-control">
                  ...
                  <select name="province" id="province1" class="form-control">
                      ...
                      <?php
                        $region = "SELECT * FROM refprovince WHERE regCode = '".$row['regCode']."' ORDER BY id";
                        $region_result = mysqli_query($conn, $region);
                          while ($row1 = mysqli_fetch_assoc($region_result)) {
                            echo " 
                  ...
                  <select name="municipal" id="municipal1" class="form-control">
                  ...
                  <select name="brgy" id="brgy1" class="form-control">
...
<div class="col-6">
      ...
      <input type="text" class="form-control" name="email" placeholder="Email Address" value="<?php echo $row['email'] ?>"readonly>
    </div> <div class="col-6">
      <label><strong>Contact Number</strong></label>
      <input type="text" class="form-control" name="age" placeholder="Age" value="<?php echo $row['phone_num'] ?>"readonly>
    </div>
</div>
</div>
</div>
...
<div class="col-md-6">
      <label><strong>Email Address</strong></label>
      <input type="text" class="form-control" name="email" placeholder="Email Address" value="<?php echo $row['email'] ?>" required>
    </div>
    <div class="col-md-6">
      <label><strong>Contact Number</strong></label>
      <input type="text" class="form-control" name="num" placeholder="Phone Number" value="<?php echo $row['phone_num'] ?>" required>
    </div>
</div>
</div>
</div>
...
<div class="modal fade" id="delete<?php echo $row['pkpt_id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <!-- Modal DELETE -->
<div class="modal fade" id="qwerty" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header bg-success text-white">
    <form action="includes/U_A_QUERY/delete.php" method="POST" enctype="multipart/form-data">
