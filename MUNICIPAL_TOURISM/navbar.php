<nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
  ...
  <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
    <li class="nav-item dropdown">
      ...
      <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><span class="h5 text-light"><?php echo $user['mt_fname'] ?></span> <img class="rounded-circle" src="../photo/municipal/<?php echo $user['photo']; ?>" height="40px" class="img-rounded" /></a>
      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
        ...
        <li>
          <a href="update_account.php" class="dropdown-item"><i class="fa fa-edit"></i> Update Profile</a>
        </li>
        <li>
          <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#update_account"><i class="fa fa-lock"></i> Update Account</a>
        </li>
        <li>
          <a href="scan.php" class="dropdown-item"><i class="fa fa-qrcode"></i> Scan Qr Code</a>
        </li>
        <li>
