...
try {
    ...
    $mail->Body    = 'To Reset your Account Please Click here <a href="http://localhost/capstone/MUNICIPAL_TOURISM/change_pass.php?code='.$code.'">Click Here</a>';
    ...
    if (mysqli_num_rows($result) <= 0) {
       ...
       header("location: ../../fp_uniqueID.php");
        ...
        $update_code = mysqli_query($conn, "UPDATE tbl_municipal_tourism SET user_id = '$code' WHERE mt_email = '$email' ");
        $mail->send();
