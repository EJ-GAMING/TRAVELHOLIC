        ...
        <div class="row">
            <div class="col-md">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card mt-3">
                            <div class="card-header bg-success text-light h5 text-center">Tourist Requirements</div>
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-4 mb-2">
                                        <div class="card">
                                            <div class="card-header text-center bg-success text-light h5 text-center">Tourist Image</div>
                                            <div class="card-body">
                                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header text-center bg-success text-light h5 text-center">VALID ID</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header text-center bg-success text-light h5 text-center">Additional Requirements Document</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
                        ...
                        <div class="card-header bg-success text-light h5 text-center">Tourist Requirements</div>
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-4 mb-2">
                                        <div class="card">
                                            <div class="card-header bg-success text-light h5 text-center">Tourist Image</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header bg-success text-light h5 text-center">VALID ID</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header bg-success text-light h5 text-center">Additional Requirements Document</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
