<nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
  ...
  <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><span class="h5 text-light"><?php echo $user['fname']; ?> </span><img class="rounded-circle" src="../photo/<?php echo $user['photo'] ?>" height="40px" /></a>
