...
try {
    ...
    $mail->Body    = 'To Reset your Account Please Click here <a href="http://localhost/capstone/TOURIST_SPOT_MANAGER/change_pass.php?code='.$code.'">Click Here</a>';
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';



    $send_email = "SELECT * FROM tbl_ts_manager
    ...
    if (mysqli_num_rows($result) <= 0) {
       ...
       header("location: ../../fp_uniqueID.php");
        ...
        $update_code = mysqli_query($conn, "UPDATE tbl_ts_manager
                                            INNER JOIN tbl_tsm_info ON tbl_ts_manager.tsm_id = tbl_tsm_info.tsm_id
                                            SET user_id = '$code' 
                                            WHERE email = '$email' ");
        $mail->send();
