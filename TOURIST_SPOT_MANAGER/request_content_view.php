...
INNER JOIN refbrgy ON tbl_tourist_address.tbrgy = refbrgy.brgyCode
 WHERE tbl_ts_manager.tsm_id = '".$_SESSION['tsm101']."' AND tbl_tourist_info.pktourist_id = '$tourist_id'";
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="row">
                    ...
                    <h1 class="mt-3">Tourist Information</h1>
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                <a href="pending_req.php" class="btn btn-flat text-dark"><i class="fa fa-arrow-left fa-2x"></i></a>
                            </div>
                        </div>
                    <?php include_once 'approved_view.php'; ?>
