...
<table id="datatablesSimple">
    <thead class="bg-success h6 text-white">
...
<a href="approved_content_view.php?view=<?php echo $row['pktourist_id'] ?>" class="btn btn-success btn-sm btn-flat text-white">
<i class="fas fa-search me-1"></i>View</a>
<a  class="btn btn-primary btn-sm btn-flat text-white" data-bs-toggle="modal" data-bs-target="#undo<?php echo $row['pktourist_id']; ?>" >
...
<!-- Modal Undo -->
<div class="modal fade" id="undo<?php echo $row['pktourist_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header bg-success text-white">
