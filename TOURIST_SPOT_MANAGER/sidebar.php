                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="update_account.php"><i class="fas fa-user mr-1"></i>Update Account</a>
                                    <a class="nav-link" href="tourist_spot.php"><i class="fas fa-globe mr-1"></i>Update Tourist Spot</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#request" aria-expanded="false" aria-controls="collapseLayouts">
                                ...
                                Booked <span class="ml-3 bg-danger text-center" style="width:20px;" id="total1">0</span>
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="request" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="pending_req.php">
                                        <i class="fas fa-comment mr-1"></i>Pending Request<span class="ml-1 bg-danger text-center" style="width:20px;" id="total2">0</span></a>
...
function loadDoc1() {
  ...
  xhttp1.open("GET", "includes/REQUEST/request.php", true);
  xhttp1.send();
...
xhttp2.open("GET", "includes/REQUEST/request.php", true);
xhttp2.send();
