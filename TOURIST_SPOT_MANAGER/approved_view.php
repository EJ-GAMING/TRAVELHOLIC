                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header text-center bg-success text-light h6">Additional Requirements Document</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card mt-3">
                            <div class="card-header text-center bg-success text-light h5">Tourist Requirements</div>
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-md-4 mb-2">
                                        <div class="card">
                                            <div class="card-header text-center text-center bg-success text-light h6">Tourist Image</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header text-center text-center bg-success text-light h6">VALID ID</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header text-center text-center bg-success text-light h6">Additional Requirements Document</div>
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md d-flex justify-content-center mb-2">
