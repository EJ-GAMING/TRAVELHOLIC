  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row">
          ...
          <img class="rounded-circle" src="../photo/<?php echo $user['img']?>"height="150px" class="thumbnail"/>          </div>
      </div>
      <div class="row">
          <div class="col">
              <label>Fullname</label>
              <input type="text" name="fname" class="form-control" value="<?php echo $user['ptfname']. ' '.$user['ptlname'] ?>" readonly>
          </div>
      </div>  
      <div class="row">
          <div class="col">
              <label>Username</label>
              <input type="text" name="uname" class="form-control" value="<?php echo $user['uname'] ?>" readonly>
          </div>
      </div>
      <div class="row">
          <div class="col">
...
<div class="modal fade" id="img<?php echo $user['pkpt_id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    <div class="modal-header bg-success text-white">
        <h5 class="modal-title" id="exampleModalLabel">Travelholic Tourbooking System</h5>
      ...
      <form action="includes/UPDATE/update_profile.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="pt_id" value="<?php echo $user['pkpt_id'] ?>">
            <div class="row">
              ...
              <img src="../photo/<?php echo $user['img'] ?>" height="165px" width="200px"/> 
            </div>
            </div>
...
<div class="modal fade" id="update_account" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" Value="<?php echo $user['ptfname']. ' '.$user['ptlname'];?>" readonly>
    </div>
  </div>
  <div class="form-group row">
    <label for="uname" class="col-sm-2 col-form-label"><strong> Username</strong></label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="uname" id="uname" placeholder="Username" Value="<?php echo $user['uname'];?>">
    </div>
  </div>
  <div class="form-group row">
