                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="date_book" readonly value="<?php echo $view['qr_location'] ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row mt-3">
                            <div class="col-md d-flex justify-content-center">
                                <img src="../QR_CODE/<?php echo $view['qr_location'] ?>.png"  height="350px" width="300px" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
