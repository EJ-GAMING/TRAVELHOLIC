                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="tourist_spot.php"><i class="fas fa-globe mr-1"></i>Tourist Spot</a>
                                    <a class="nav-link" href="user_account.php"><i class="fas fa-users mr-1"></i>Tourist Manager</a>
                                    <a class="nav-link" href="municipal_tourism.php"><i class="fas fa-user mr-1"></i>Municipal Tourism</a>
                                </nav>
                            </div>
