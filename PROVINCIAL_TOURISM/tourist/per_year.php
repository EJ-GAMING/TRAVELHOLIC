    ...
    <?php include_once 'sidebar.php';?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <h1 class="mt-3">List of Tourist In Current Year</h1>
                        <ol class="breadcrumb mb-4">
                            ...
                            <div class="row">
                                <div class="col-md d-grid gap-2 d-md-flex justify-content-md-end mb-3">
                                       <div class="row">
                                           <div class="col-md">
                                                <input type="number" name="txt_search" class="form-control" id="txt_search" placeholder="ex. 2021">    
                                           </div>
                                           <div class="col-md">
                                           <button type="submit" class="btn btn-primary" id="btn_search"> Search Here</button>                                           </div>
                                       </div>
                                </div>
                            </div>
...
WHERE STATUS = 'Approved' AND YEAR(book_date)=YEAR(NOW())
                    ...
                    while($row = mysqli_fetch_assoc($select_result)){
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td>
                          <a href="peryear_info.php?view=<?php echo $row['pktourist_id']; ?>" class="btn btn-success btn-sm btn-flat text-white">
