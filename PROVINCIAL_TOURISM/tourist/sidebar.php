            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed text-white" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon active text-white"><i class="fas fa-users"></i></div>
                                User Account
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="tourist_spot.php"><i class="fas fa-globe mr-1"></i>Tourist Spot</a>
                                    <a class="nav-link" href="user_account.php"><i class="fas fa-user mr-1"></i>Tourist Manager</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="tourist" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="tourist/perday.php"><i class="fas fa-comment mr-1"></i>Per Day</a>
                                    <a class="nav-link" href="tourist/per_month.php"><i class="fas fa-users mr-1"></i>Per Month</a>
                                    <a class="nav-link" href="tourist/per_year.php"><i class="fas fa-users mr-1"></i>Per Year</a>
                                </nav>
                            </div>
                    ...
                    <div class="sb-sidenav-footer">
                       ...
                       <?php echo $user['ptfname']. ' '. $user['ptlname']?>
                    </div>
                </nav>
            </div>
